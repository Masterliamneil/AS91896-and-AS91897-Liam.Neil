...
class Calculator:
    ...
    Cuboid_Volume_Formula = 'self.num1*self.num2*self.num3' #With use of eval(Cuboidformula) can be used as an equation directory.
    ...
    Cuboid_Surface_Formula = "2*(self.num1*self.num2+self.num1*self.num3+self.num2*self.num3)"
    Cylinder_Surface_Formula = "2*self.pi*self.num2*self.num3+2*self.pi*self.num2**2"
    ...
    def __init__(self):
        """
        Intializes code and tab specifactions
        """
        ...
        self.Cuboid_img = gui.PhotoImage(file="Cuboid.png")
    ...
    def savefunction(self):
        """
        Assembles code and places it into text document
        """
    ...
    def Visual_Message(self, message):
        """
        if there is a label, destroy it, place new label with text dependent on part specifyed in code then clears entry
        """
        if self.label2 != None:
            self.label2.destroy()
    ...
    def Current_Equation(self):
        """
        Destroys equation so it may be replaced and shows current equation
        """
        if self.label != None:
            self.label.destroy()
    ...
    def Back_Menu_Button(self):
        """
        Creates a Button that on click clears menu and recreates the inital state
        """
    ...
    def Menu_Button_format(self, Shape, Shape_Command, Place_X, Place_Y):
        """
        Creates a Button out of the given variables for place, command and text
        """
    ...
    def Initial_Equation_Menu(self, Text_A, Text_B):
        """
        intializes the calculator input box for use
        """
        self.label2 = gui.Label(self.root, text=Text_A, font=("Helvetica", 14))
        self.label2.place(y=200)
        self.label = gui.Label(self.root, text=Text_B, font=("Helvetica", self.Fontsize), wraplength=500)
        self.label.place(y=20)
    ...
    def submit(self, event=None):
        ...
        if self.num1 == "X":
            try:
                ...
                placeholder = float(self.entry.get())
                if placeholder > 0:
                    ...
                    self.Visual_Message("Please use valid number for X")
                    return
                #if it doesn't work, tell them to input again until valid.
            except ValueError:
                self.Visual_Message("Please use valid number for X")
        ...
        # checks if there isn't already another value for Y
            ...
            try:
                ...
                if placeholder > 0:
                    ...
                    self.Visual_Message("Please use valid number for Y")
                    return
            #if it doesn't work, tell them to input again until valid.
            except ValueError:
                self.Visual_Message("Please use valid number for Y")
            ...
            try:
                ...
                if placeholder > 0:
                    ...
                    if self.label != None:
                        ...
                        self.label2 = gui.Label(self.root, text=f"={round(self.answer, 6):g}{self.Unit}", font=("Helvetica", 18))
                    ...
                    self.Visual_Message("Please use valid number for Z")
                    return
            #if it doesn't work, tell them to input again until valid.
            except ValueError:
                self.Visual_Message("Please use valid number for Z")
    ...
    def button_clicked_Volume(self):
        #nessacairy to keep correct answer and data for documents, changes based on either volume (^3) and surface area (^2)
        self.Unit = "Units^3"
        #Full page removal of button and gui
        for widget in self.root.winfo_children():
            widget.destroy()
        #places all the buttons for the shapes and feeds back the command to their respective code
        self.Menu_Button_format(Shape="Cuboid\n❒",Shape_Command=self.Cuboid_Button_Volume_Clicked, Place_X=8, Place_Y=10)
        self.Menu_Button_format(Shape="Cylinder\n🛢" ,Shape_Command=self.Cylinder_Button_Volume_Clicked, Place_X=252, Place_Y=10)
        self.Menu_Button_format(Shape="Sphere\n🔵" ,Shape_Command=self.Sphere_Button_Volume_Clicked, Place_X=8, Place_Y=250)
        self.Menu_Button_format(Shape="Cone\n𓉴" ,Shape_Command=self.Cone_Button_Volume_Clicked, Place_X=252, Place_Y=250)
        self.Menu_Button_format(Shape="Square Based Pyramid\n☒" ,Shape_Command=self.SquarePyramid_Button_Volume_Clicked, Place_X=8, Place_Y=490)
        self.Menu_Button_format(Shape="Regular Triangle Based Pyramid\n⛛" ,Shape_Command=self.TrianglePyramid_Button_Volume_Clicked, Place_X=252, Place_Y=490) 
    ...
    def button_clicked_Surface(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #places all the buttons for the shapes and feeds back the command to their respective code
        self.Menu_Button_format(Shape="Cuboid\n❒",Shape_Command=self.Cuboid_button_Surface_clicked, Place_X=8, Place_Y=10)
    ...
    def Cuboid_Button_Volume_Clicked(self):
        self.question = self.Cuboid_Volume_Formula #use this to set what button and equation instead of making a new submit function for each.
        self.title = "Cuboid Volume ="
        #Full page removal of button and gui
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for X", Text_B="Cuboid Volume =\nX*Y*Z")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
        self.current_visual = "{title}{x}*{y}*{z}"
        #places image
        IMG = gui.Label(self.root, image=self.Cuboid_img)
        IMG.place(x=125, y=360)

    def Cylinder_Button_Volume_Clicked(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Y", Text_B="Cylinder Volume =\nπ*Y*Z^2")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def Sphere_Button_Volume_Clicked(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Z", Text_B="Sphere Volume =\nπ*(4/3)*Z^3")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def Cone_Button_Volume_Clicked(self): 
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Y", Text_B="Cone Volume =\nπ*(Y^2)*(Z/3)")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def SquarePyramid_Button_Volume_Clicked(self): 
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for X", Text_B="Square Pyramid Volume =(X*Y*Z)/3")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def TrianglePyramid_Button_Volume_Clicked(self): 
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for X", Text_B="Triangle Pyramid Volume =(0.5*X*Y*Z)/3")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
        self.current_visual = "{title}{x}*{y}*{z})/3"
    ...
    def Cuboid_button_Surface_clicked(self):
        self.question = self.Cuboid_Surface_Formula #use this to set what button and equation instead of making a new submit function for each.
        self.title = "Cuboid Surface Area ="
        #Full page removal of button and gui
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
    ...
    def Cylinder_button_Surface_clicked(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Y", Text_B="Cylinder Surface Area =\n2π*Y*Z+2π*Y^2")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #sets num to the required without user input
        #formats equation
    ...
    def Sphere_button_Surface_clicked(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Z", Text_B="Sphere Surface Area =\n4*π*Z^2")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def Cone_button_Surface_clicked(self):
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for Y", Text_B="Cone Surface Area =\nπ*Y*(Y+(Z^2+Y^2)^0.5)")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def SquarePyramid_button_Surface_clicked(self): 
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for X", Text_B="Square Pyramid Surface Area =Y*X+Y*((X/2)^2+Z^2)^0.5+X*((Y/2)^2+Z^2)^0.5")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
    ...
    def TrianglePyramid_button_Surface_clicked(self): 
        ...
        for widget in self.root.winfo_children():
            widget.destroy()
        #intializes the calculator input box for use
        self.Initial_Equation_Menu(Text_A="Please type value for X", Text_B="Triangle Pyramid Surface Area =0.5*(X*Y)+3/2*(Y*Z)")
        #Button that resets back to inital state
        self.Back_Menu_Button()
        #formats equation
